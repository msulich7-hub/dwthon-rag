...
export function MesKioskCompleteDialog({
  ...
  return (
    <div className="fixed inset-0 z-[105] flex items-center justify-center bg-black/50 p-4" data-testid="mes-kiosk-complete-dialog">
      <div className="w-full max-w-sm rounded-2xl bg-card border-2 p-6 space-y-4 text-center">
        ...
        <div className="flex flex-col gap-2">
          <Button type="button" className="min-h-14 text-lg" data-testid="mes-kiosk-confirm-complete" onClick={onConfirm}>
